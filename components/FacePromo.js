          ...
          <div css={css`padding-top: 6rem;`}>
            ...
            <div css={css`position: relative`}>
              <div css={css`width: 100%; display: flex; justify-content: center; padding-top: 1rem;`}>
                <Image src={FacePromoTitle} css={css`width: 522px; height: 52px`} />
              </div>
              <div css={css`position: absolute; right: 0px;`}>
                <Image src={Line} css={css`width: 522px; height: 52px`} />
              </div>
            </div>
            <div css={css`display: flex; justify-content: center; align-items: center`}>
              <Image src={FaceLift} css={css`width: 570px; height: 620px`} />
            </div>
            <div css={css`display: flex; justify-content: center; align-items: center;`}>
              ...
              <div css={css`padding-left: 1rem; display: flex; justify-content: center; align-items: center;`}><Image src={NoSvg} css={css`width: 93px; height: 80px`}/></div>
            </div>
            <div css={css`display: flex; justify-content: center; align-items: center; padding-top: 2rem;`}>
              <div css={css`display: grid; grid-template-columns: repeat(3, minmax(0, 1fr));`}>
                <div css={css`padding-left: 0.5rem;`}><Image src={FaceUp} css={css`width: 265px; height: 205px`} /></div>
                <div css={css`padding-left: 0.5rem;`}><Image src={ChinUp} css={css`width: 265px; height: 205px`} /></div>
                <div css={css`padding-left: 0.5rem;`}><Image src={FaceDown} css={css`width: 265px; height: 205px`} /></div>
              </div>
            </div>
